...
from lavis.datasets.builders.sentence_builder import LaionSentence115MBuilder    #### added
from lavis.datasets.builders.my_vatex_caption_builder import MyVATEXCapBuilder    #### added
...
__all__ = [
    ...
    "VGVQABuilder",
    "AVSDDialBuilder",
    "LaionSentence115MBuilder",   ### added
    "MyVATEXCapBuilder",   ### added
]
