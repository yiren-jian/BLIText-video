...
from lavis.models.blip2_models.darkformer_opt import DarkformerOPT   ##### added model
from lavis.models.blip2_models.blip2_qformer_darkformer import Blip2QformerDarkformer   ##### added model
from lavis.models.blip2_models.blip2_darkformer_opt import Blip2DarkformerOPT   ##### added model
from lavis.models.blip2_models.video_feature_opt import VideoFeatureOPT   ##### added model
from lavis.models.blip2_models.video_feature_opt_new import VideoFeatureOPTNew   ##### added model
from lavis.models.blip2_models.video_feature_opt_stage1 import VideoFeatureOPTStage1   ##### added model
from lavis.models.blip2_models.video_feature_opt_stage2 import VideoFeatureOPTStage2   ##### added model
...
__all__ = [
    ...
    "BlipVQA",
    "Blip2Qformer",
    "DarkformerOPT",   ### added model
    "Blip2QformerDarkformer",   ### added model
    "Blip2DarkformerOPT",   ### added model
    "VideoFeatureOPT",   ##### added model
    "VideoFeatureOPTNew",   ##### added model
    "VideoFeatureOPTStage1",   ##### added model
    "VideoFeatureOPTStage2",   ##### added model
    "Blip2Base",
    "Blip2ITM",
    "Blip2OPT",
    "Blip2T5",
