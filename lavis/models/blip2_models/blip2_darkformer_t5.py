...
@registry.register_model("blip2_darkformer_t5")
class Blip2DarkformerT5(Blip2Base):
    """
    BLIP2 T5 model.
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "pretrain_darkformer_flant5xl": "configs/models/blip2/blip2_pretrain_flant5xl.yaml",
        "pretrain_darkformer_flant5xxl": "configs/models/blip2/blip2_pretrain_flant5xxl.yaml",
    }
    ...
    def forward(self, samples):
        ...
        with torch.no_grad():
            ...
            inputs_t5_ref = self.Darkformer.cls_proj(text_output.last_hidden_state[:, 0, :])
            inputs_t5_ref = inputs_t5_ref.reshape(bsz, n_query, hdim)
            inputs_t5_ref = self.Darkformer.pooler(inputs_t5_ref)
            inputs_t5_ref = self.Darkformer.t5_proj(inputs_t5_ref)

        inputs_t5_ref = inputs_t5_ref.detach()
        loss_align = nn.MSELoss()(inputs_t5, inputs_t5_ref) * self.loss_weight
        ###### new code ends  ######
