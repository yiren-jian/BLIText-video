...
@registry.register_model("blip2_darkformer")
class Blip2QformerDarkformer(Blip2Base):
    """
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "pretrain_darkformer": "configs/models/blip2/blip2_pretrain.yaml",
    }
    ...
    def __init__(
        ...
        ###### new code for OPT config #####
        opt_hidden_size = OPTConfig.from_pretrained("facebook/opt-2.7b").hidden_size
        ...
        self.Darkformer.opt_proj = nn.Linear(
            self.Darkformer.config.hidden_size, opt_hidden_size
        )
    ...
    def forward(self, samples):
        ...
        return BlipOutput(
            loss=loss_itc + loss_itm + loss_lm + loss_align,
            loss_itc=loss_itc,
            loss_itm=loss_itm,
            loss_lm=loss_lm,
        )
