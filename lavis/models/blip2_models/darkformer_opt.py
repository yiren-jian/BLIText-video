...
@registry.register_model("darkformer_opt")
class DarkformerOPT(Blip2Base):

    PRETRAINED_MODEL_CONFIG_DICT = {
        "darkformer_opt2.7b": "configs/models/blip2/blip2_pretrain_opt2.7b.yaml",  ### TODO
        "darkformer_opt6.7b": "configs/models/blip2/blip2_pretrain_opt6.7b.yaml",  ### TODO
    }
    ...
    def forward(self, samples):
        ...
        inputs_opt = self.Darkformer.cls_proj(text_output.last_hidden_state[:, 0, :])   ### 1x768 --> 1x(32x768)
        inputs_opt = inputs_opt.reshape(bsz, n_query, hdim)   ### 1x(32x768) --> 1x32x768
        inputs_opt = self.Darkformer.pooler(inputs_opt)
        inputs_opt = self.Darkformer.opt_proj(inputs_opt)  ### 768 --> 2560
