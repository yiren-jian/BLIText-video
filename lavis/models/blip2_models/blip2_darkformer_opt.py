...
@registry.register_model("blip2_darkformer_opt")
class Blip2DarkformerOPT(Blip2Base):
    """
    BLIP2 OPT model.
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "pretrain_darkformer_opt2.7b": "configs/models/blip2/blip2_pretrain_opt2.7b.yaml",
        "pretrain_darkformer_opt6.7b": "configs/models/blip2/blip2_pretrain_opt6.7b.yaml",
    ...
    def forward(self, samples):
        ...
        loss = loss_align + loss_lm   ### new loss
        return {"loss": loss}
